	...
	with open(file) as f1:
		...
		for line in list_of_rows2:
			...
			if not (a in unused_list):
				ThrList.append(float(line[user])/1000)
	return ThrList
...
if __name__ == "__main__":
	...
	list_all.append(getthrList(ThrFILE,8,unused_list))
	list_all.append(getthrList(ThrFILE,9,unused_list))
	list_all.append(getthrList(ThrFILE,10,unused_list))
	...
	plt.savefig("S4-bar-Latency.jpg")
