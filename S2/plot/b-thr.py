...
# plt.bar(x-1.5*width, (NC_list), width, color='steelblue',label = 'NC')
# plt.bar(x-0.5*width, (PD_list), width, color='purple',label = 'PD')
# plt.bar(x+0.5*width, (PD15_list), width, color='peru',label = 'PD+BM')
